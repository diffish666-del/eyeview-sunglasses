...
export const metadata: Metadata = {
  ...
  description: 'Wholesale wayfarer sunglasses manufacturer. Premium acetate frames, UV400/polarized lenses, custom logo printing. MOQ 100pcs. Factory direct pricing from $5/pair. Free samples!',
  keywords: 'wholesale wayfarer sunglasses, wayfarer sunglasses manufacturer, custom wayfarer sunglasses, acetate sunglasses wholesale, square frame sunglasses, OEM wayfarer sunglasses',
  openGraph: {
    title: 'Wholesale Wayfarer Sunglasses Manufacturer | Custom Wayfarer OEM - EyeView',
                ...
                <table className="w-full">
                  <thead>
                    <tr className="bg-gray-100">
                      ...
                      <th className="px-6 py-3 text-left font-semibold text-gray-700">✈️ <Link href="/products/aviator" className="text-primary-600 hover:underline">Aviator</Link></th>
                    </tr>
                  </thead>

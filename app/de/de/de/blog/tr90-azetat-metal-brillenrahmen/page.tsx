...
export const metadata: Metadata = {
  ...
  alternates: {
    ...
    languages: {
      ...
      'de': '/de/blog/tr90-azetat-metal-brillenrahmen',
    },
  },
}
    ...
    <article className="py-12">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          "@type": "Article",
          "headline": "TR90 vs Acetat vs Metall Sonnenbrillen Rahmen: Der Vollständige Käuferführer 2026",
        ...
        <header className="mb-12">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
            TR90 vs Acetat vs Metall Sonnenbrillen Rahmen: Der Vollständige Käuferführer 2026
          </h1>
          <p className="text-xl text-gray-600">
            Ich stelle seit über 10 Jahren Brillenrahmen her. Und die #1 Frage, die Markeninhaber mir stellen: 
            Welches Material soll ich verwenden? Die Antwort hängt von Ihrem Preisniveau, Ihrem Kunden und dem ab, was Sie erreichen möchten. Lassen Sie mich das aufschlüsseln.
          </p>
        ...
        <nav className="bg-gray-100 rounded-xl p-6 mb-12">
          ...
          <ul className="space-y-2">
            <li><a href="#die-drei-materialien" className="text-primary-600 hover:underline">Die Drei Hauptmaterialien</a></li>
            <li><a href="#tr90" className="text-primary-600 hover:underline">TR90: Das Flexible Wunder</a></li>
            <li><a href="#acetat" className="text-primary-600 hover:underline">Acetat: Der Mode-Standard</a></li>
            <li><a href="#metall" className="text-primary-600 hover:underline">Metall: Die Klassische Wahl</a></li>
            <li><a href="#vergleich" className="text-primary-600 hover:underline">Seit-an-Seit Vergleich</a></li>
            <li><a href="#kosten" className="text-primary-600 hover:underline">Kostenübersicht für Ihre Marke</a></li>
            <li><a href="#waehlen" className="text-primary-600 hover:underline">Wie Sie das Richtige Material Wählen</a></li>
            <li><a href="#trend" className="text-primary-600 hover:underline">Materialtrends 2026</a></li>
            <li><a href="#faq" className="text-primary-600 hover:underline">Fragen, die Mich Jede Woche Erreichen</a></li>
          </ul>
        </nav>

        <section id="die-drei-materialien" className="mb-12">
          <h2 className="text-3xl font-bold text-gray-900 mb-6">Die Drei Hauptmaterialien</h2>
        ...
        <section id="tr90" className="mb-12">
          <h2 className="text-3xl font-bold text-gray-900 mb-6">TR90: Das Flexible Wunder</h2>
          
          <h3 className="text-2xl font-bold text-gray-900 mb-4">Was ist TR90?</h3>
          <p className="text-gray-700 mb-4">
            TR90 ist ein Thermoplast-Material, das vom Schweizer Unternehmen EMS-Chimie entwickelt wurde. Technisch heißt es &quot;Gril TR90&quot; (das ist der Markenname), aber alle in der Industrie nennen es einfach TR90. Es ist bekannt dafür, unglaublich leicht und flexibel zu sein.
          </p>
          ...
          <ul className="list-disc pl-6 space-y-2 text-gray-700 mb-6">
            <li>Sport- und Active-Lifestyle-Sonnenbrillen</li>
            <li>Kinder-Sonnenbrillen (flexibel, leicht, unzerbrechlich)</li>
            <li>Budgetfreundliche Mode-Linien</li>
            <li>Wrap-around- und Leistungsdesigns</li>
            <li>Kunden, die ganztägigen Komfort wollen</li>
          </ul>
        ...
        <section id="acetat" className="mb-12">
          <h2 className="text-3xl font-bold text-gray-900 mb-6">Acetat: Der Mode-Standard</h2>
          
          <h3 className="text-2xl font-bold text-gray-900 mb-4">Was ist Acetat?</h3>
          <p className="text-gray-700 mb-4">
            Acetat (Zelluloseacetat) ist ein pflanzlicher Kunststoff aus Baumwollfasern oder Holzmasse. Es ist das Premium-Material der Wahl für Mode-Sonnenbrillen. Luxuxmarken wie Tom Ford, Gucci, Prada und Ray-Ban verwenden fast ausschließlich Acetat für ihre Mode-Rahmen.
          </p>
          ...
          <h3 className="text-2xl font-bold text-gray-900 mb-4">Am Besten Für</h3>
          <ul className="list-disc pl-6 space-y-2 text-gray-700 mb-6">
            <li>Mode- und Luxusmarken</li>
            <li>Statement-Stücke und kühne Designs</li>
            <li>Premium-Einzelpreise ($80-$300+)</li>
            <li>Marken, die einzigartige Farb-/Musterkombinationen wollen</li>
            <li>Kunden, die Handwerk und Premium-Gefühl schätzen</li>
          </ul>
        ...
        <section id="metall" className="mb-12">
          <h2 className="text-3xl font-bold text-gray-900 mb-6">Metall: Die Klassische Wahl</h2>
          
          <h3 className="text-2xl font-bold text-gray-900 mb-4">Woraus Metallrahmen Bestehen</h3>
          <p className="text-gray-700 mb-4">
            Metall-Sonnenbrillenrahmen bestehen typischerweise aus:
          </p>
          <ul className="list-disc pl-6 space-y-2 text-gray-700 mb-6">
          ...
          <div className="bg-red-50 border-l-4 border-red-500 p-4 mb-6">
            <p className="text-red-800 font-medium">⚠️ Fabriktwarnung: Geben Sie immer &quot;nickelfrei&quot; an, wenn Sie Metallrahmen beschaffen. Nickelallergie ist eine der häufigsten Kontaktallergien weltweit. Bitten Sie Ihren Lieferanten um SGS- oder RoHS-Zertifizierung, um die Legierungszusammensetzung zu验证证.</p>
          </div>
        </section>

        <section id="faq" className="mb-12">
          <h2 className="text-3xl font-bold text-gray-900 mb-6">Fragen, die Mich Jede Woche Erreichen</h2>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-gray-50 rounded-lg p-6">
              <h3 className="text-xl font-bold text-gray-900 mb-3">Welches Rahmenmaterial ist am besten für Mode-Brillen?</h3>
              <p className="text-gray-700">
                Acetat ist der Goldstandard für Mode-Sonnenbrillen. Es kann in kühne, dicke Formen geschnitten, hochglanzpoliert werden und kommt in Hunderten von Farben und Mustern (Schildpatt, Marmor, Farbverlauf, transparent). Luxuxmarken wie Tom Ford, Gucci und Prada verwenden fast ausschließlich Acetat. Wenn Ihre Marke im Premium- oder Mode-Segment positioniert ist, ist Acetat das, was Ihre Kunden erwarten.
              </p>
            </div>

            <div className="bg-gray-50 rounded-lg p-6">
              <h3 className="text-xl font-bold text-gray-900 mb-3">Wie viel kosten verschiedene Rahmenmaterialien im Großhandel?</h3>
              <p className="text-gray-700">
                Im Werks-Großhandel: TR90-Rahmen kosten $3-8/Paar je nach Komplexität. Acetatrahmen kosten $5-15/Paar (handpoliertes Premium-Acetat kann $20+ erreichen). Metallrahmen kosten $4-12/Paar je nach Legierung und Beschichtung. Also ist TR90 am budgetfreundlichsten, Acetat hat die breiteste Palette, und Metall liegt in der Mitte.
              </p>
            </div>

            <div className="bg-gray-50 rounded-lg p-6">
              <h3 className="text-xl font-bold text-gray-900 mb-3">Sind Metallrahmen besser für Menschen mit Allergien?</h3>
              <p className="text-gray-700">
                Es hängt vom Metall ab. Edelstahl und Titan sind hypoallergen und sicher für empfindliche Haut. Einige billigere Metalllegierungen enthalten jedoch Nickel, was allergische Reaktionen verursachen kann. Wenn Sie Metallrahmen für eine Marke beschaffen, geben Sie immer nickelfreie Legierungen an und bitten Sie um SGS- oder RoHS-Zertifizierung. TR90 und Acetat sind natürlich hypoallergen.
              </p>
            </div>
          </div>
        </section>
        ...
        <div className="mt-12 pt-8 border-t border-gray-200">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">Verwandte Produkte</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Link href="/de/produkte/tr90" className="block group">
              <div className="bg-gray-100 rounded-lg p-6 text-center group-hover:bg-gray-200 transition-colors">
                <h3 className="font-bold text-gray-900 mb-2">TR90 Sonnenbrillen</h3>
                <p className="text-sm text-gray-600">Leicht & flexibel</p>
              </div>
            </Link>
            <Link href="/de/produkte/acetat" className="block group">
              <div className="bg-gray-100 rounded-lg p-6 text-center group-hover:bg-gray-200 transition-colors">
                <h3 className="font-bold text-gray-900 mb-2">Acetat Sonnenbrillen</h3>
                <p className="text-sm text-gray-600">Premium Mode-Rahmen</p>
              </div>
            </Link>
            <Link href="/de/produkte/metall" className="block group">
              <div className="bg-gray-100 rounded-lg p-6 text-center group-hover:bg-gray-200 transition-colors">
                <h3 className="font-bold text-gray-900 mb-2">Metall Sonnenbrillen</h3>
                <p className="text-sm text-gray-600">Klassisch & elegant</p>
              </div>
            </Link>
          </div>
        </div>

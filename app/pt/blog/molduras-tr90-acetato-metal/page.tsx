...
export const metadata: Metadata = {
  ...
  alternates: {
    ...
    languages: {
      ...
      'pt': '/pt/blog/molduras-tr90-acetato-metal',
    },
  },
}
    ...
    <article className="py-12">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          "@type": "Article",
          "headline": "Molduras TR90 vs Acetato vs Metal: O Guia Completo do Comprador 2026",
        ...
        <header className="mb-12">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
            Molduras TR90 vs Acetato vs Metal: O Guia Completo do Comprador 2026
          </h1>
          <p className="text-xl text-gray-600">
            Estou fabricando molduras de óculos há mais de 10 anos. E a pergunta #1 que donos de marcas me fazem: 
            Qual material devo usar? A resposta depende do seu ponto de preço, seu cliente e o que você está tentando alcançar. Deixe-me detalhar.
          </p>
        ...
        <nav className="bg-gray-100 rounded-xl p-6 mb-12">
          ...
          <ul className="space-y-2">
            <li><a href="#os-tres-materiais" className="text-primary-600 hover:underline">Os Três Materiais Principais</a></li>
            <li><a href="#tr90" className="text-primary-600 hover:underline">TR90: A Maravilha Flexível</a></li>
            <li><a href="#acetato" className="text-primary-600 hover:underline">Acetato: O Padrão de Moda</a></li>
            <li><a href="#metal" className="text-primary-600 hover:underline">Metal: A Escolha Clássica</a></li>
            <li><a href="#comparacao" className="text-primary-600 hover:underline">Comparação Lado a Lado</a></li>
            <li><a href="#custo" className="text-primary-600 hover:underline">Detalhamento de Custos para Sua Marca</a></li>
            <li><a href="#escolher" className="text-primary-600 hover:underline">Como Escolher o Material Correto</a></li>
            <li><a href="#tendencias" className="text-primary-600 hover:underline">Tendências de Materiais 2026</a></li>
            <li><a href="#faq" className="text-primary-600 hover:underline">Perguntas que Me Fazem Toda Semana</a></li>
          </ul>
        </nav>

        <section id="os-tres-materiais" className="mb-12">
          <h2 className="text-3xl font-bold text-gray-900 mb-6">Os Três Materiais Principais</h2>
        ...
        <section id="tr90" className="mb-12">
          <h2 className="text-3xl font-bold text-gray-900 mb-6">TR90: A Maravilha Flexível</h2>
          
          <h3 className="text-2xl font-bold text-gray-900 mb-4">O que é TR90?</h3>
          <p className="text-gray-700 mb-4">
            TR90 é um material termoplástico desenvolvido pela empresa suíça EMS-Chimie. Tecnicamente chamado de &quot;Gril TR90&quot; (esse é o nome da marca), mas todos na indústria simplesmente chamam de TR90. É conhecido por ser incrivelmente leve e flexível.
          </p>
          ...
          <ul className="list-disc pl-6 space-y-2 text-gray-700 mb-6">
            <li>Óculos de sol esportivos e de estilo de vida ativo</li>
            <li>Óculos de sol para crianças (flexíveis, leves, inquebráveis)</li>
            <li>Linhas de moda econômicas</li>
            <li>Designs envolventes e de performance</li>
            <li>Clientes que querem conforto o dia todo</li>
          </ul>
        ...
        <section id="acetato" className="mb-12">
          <h2 className="text-3xl font-bold text-gray-900 mb-6">Acetato: O Padrão de Moda</h2>
          
          <h3 className="text-2xl font-bold text-gray-900 mb-4">O que é Acetato?</h3>
          <p className="text-gray-700 mb-4">
            O acetato (acetato de celulose) é um plástico de origem vegetal feito de fibras de algodão ou polpa de madeira. É o material premium de escolha para óculos de moda. Marcas de luxo como Tom Ford, Gucci, Prada e Ray-Ban usam quase exclusivamente acetato para suas molduras de moda.
          </p>
          ...
          <h3 className="text-2xl font-bold text-gray-900 mb-4">Melhor Para</h3>
          <ul className="list-disc pl-6 space-y-2 text-gray-700 mb-6">
            <li>Marcas de moda e luxo</li>
            <li>Peças de declaração e designs ousados</li>
            <li>Preços premium ao varejo ($80-$300+)</li>
            <li>Marcas que querem combinações únicas de cor/padrão</li>
            <li>Clientes que valorizam artesanato e sensação premium</li>
          </ul>
        ...
        <section id="metal" className="mb-12">
          <h2 className="text-3xl font-bold text-gray-900 mb-6">Metal: A Escolha Clássica</h2>
          
          <h3 className="text-2xl font-bold text-gray-900 mb-4">Do que São Feitas as Molduras de Metal</h3>
          <p className="text-gray-700 mb-4">
            As molduras de óculos de metal são tipicamente feitas de:
          </p>
          <ul className="list-disc pl-6 space-y-2 text-gray-700 mb-6">
          ...
          <div className="bg-red-50 border-l-4 border-red-500 p-4 mb-6">
            <p className="text-red-800 font-medium">⚠️ Aviso de Fábrica: Especifique sempre &quot;livre de níquel&quot; quando buscar molduras de metal. A alergia a níquel é uma das alergias de contato mais comuns no mundo. Peça ao seu fornecedor certificação SGS ou RoHS para verificar a composição da liga.</p>
          </div>
        </section>

        <section id="faq" className="mb-12">
          <h2 className="text-3xl font-bold text-gray-900 mb-6">Perguntas que Me Fazem Toda Semana</h2>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-gray-50 rounded-lg p-6">
              <h3 className="text-xl font-bold text-gray-900 mb-3">Qual material de moldura é melhor para óculos de moda?</h3>
              <p className="text-gray-700">
                O acetato é o padrão ouro para óculos de moda. Pode ser cortado em formas ousadas e grossas, polido a alto brilho, e vem em centenas de cores e padrões (tartaruga, mármore, degradê, transparente). Marcas de luxo como Tom Ford, Gucci e Prada usam quase exclusivamente acetato. Se sua marca se posiciona no segmento premium ou de moda, o acetato é o que seus clientes esperam.
              </p>
            </div>

            <div className="bg-gray-50 rounded-lg p-6">
              <h3 className="text-xl font-bold text-gray-900 mb-3">Quanto custam diferentes materiais de moldura no atacado?</h3>
              <p className="text-gray-700">
                No atacado de fábrica: molduras TR90 custam $3-8/par dependendo da complexidade. Molduras de acetato custam $5-15/par (acetato premium polido à mão pode alcançar $20+). Molduras de metal custam $4-12/par dependendo da liga e revestimento. Então TR90 é o mais econômico, acetato tem a faixa mais ampla, e metal fica no meio.
              </p>
            </div>

            <div className="bg-gray-50 rounded-lg p-6">
              <h3 className="text-xl font-bold text-gray-900 mb-3">Molduras de metal são melhores para pessoas com alergias?</h3>
              <p className="text-gray-700">
                Depende do metal. Aço inoxidável e titânio são hipoalergênicos e seguros para pele sensível. No entanto, algumas ligas metálicas mais baratas contêm níquel, que pode causar reações alérgicas. Se você está buscando molduras de metal para uma marca, especifique sempre ligas livres de níquel e peça certificação SGS ou RoHS. TR90 e acetato são naturalmente hipoalergênicos.
              </p>
            </div>
          </div>
        </section>
        ...
        <div className="mt-12 pt-8 border-t border-gray-200">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Link href="/pt/produtos/tr90" className="block group">
              <div className="bg-gray-100 rounded-lg p-6 text-center group-hover:bg-gray-200 transition-colors">
                <h3 className="font-bold text-gray-900 mb-2">Óculos TR90</h3>
                <p className="text-sm text-gray-600">Leves e flexíveis</p>
              </div>
            </Link>
            <Link href="/pt/produtos/acetato" className="block group">
              <div className="bg-gray-100 rounded-lg p-6 text-center group-hover:bg-gray-200 transition-colors">
                <h3 className="font-bold text-gray-900 mb-2">Óculos de Acetato</h3>
                <p className="text-sm text-gray-600">Molduras de moda premium</p>
              </div>
            </Link>
            <Link href="/pt/produtos/metal" className="block group">
              <div className="bg-gray-100 rounded-lg p-6 text-center group-hover:bg-gray-200 transition-colors">
                <h3 className="font-bold text-gray-900 mb-2">Óculos de Metal</h3>
                <p className="text-sm text-gray-600">Clássicos e elegantes</p>
              </div>
            </Link>
          </div>
        </div>

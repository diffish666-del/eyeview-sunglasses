...
export const metadata: Metadata = {
  title: `Produttore Occhiali in Acetato | Fabbrica Eyewear Acetato Artigianale - EyeView`,
  description: `Produttore di occhiali in acetato personalizzati. Acetato italiano Mazzucchelli e cinese premium. Montature lucidate a mano, 200+ colori. MOQ 100 pezzi.`,
  keywords: `produttore occhiali acetato, fabbrica occhiali acetato, occhiali acetato italiano, Mazzucchelli acetato`,
  openGraph: {
    ...
    type: 'website',
    url: 'https://eyeviewsunglasses.com/it/prodotti/acetato',
  },
  alternates: {
    canonical: 'https://eyeviewsunglasses.com/it/prodotti/acetato',
    languages: {
      'en': 'https://eyeviewsunglasses.com/products/acetate',
      'it': 'https://eyeviewsunglasses.com/it/prodotti/acetato',
    },
  },
}
...
export default function AcetatePageIt() {
  return (
    <>
        ...
        <div className="mb-12">
          ...
          <section className="mb-20">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <Link href="/it/prodotti/rotondo" className="bg-white rounded-xl p-6 border border-gray-100 hover:shadow-lg transition-all group">
                <div className="text-4xl mb-3">⭕</div>

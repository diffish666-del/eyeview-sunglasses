...
export const metadata: Metadata = {
  title: `Produttore Occhiali da Sole Aviatore all'Ingrosso | Aviatore OEM Personalizzati - EyeView`,
  description: `Produttore leader di occhiali aviatore all'ingrosso. Aviatori personalizzati con incisione logo, montature metalliche, lenti UV400/polarizzate. MOQ 100 pezzi. Diretto di fabbrica.`,
  keywords: `occhiali aviatore ingrosso, produttore occhiali aviatore, aviatore personalizzati, OEM aviatore, montatura metallica occhiali`,
  openGraph: {
...
export default function AviatorPageIt() {
  return (
    <>

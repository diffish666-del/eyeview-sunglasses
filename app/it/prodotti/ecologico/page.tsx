...
export const metadata: Metadata = {
  title: `Produttore Occhiali Ecologici | Eyewear Sostenibile all'Ingrosso - EyeView`,
  description: `Produttore di occhiali sostenibili ed ecologici all'ingrosso. Plastica oceanica riciclata, aste in bambu, montature in bio-acetato. MOQ 200 pezzi.`,
  keywords: `produttore occhiali sostenibili, occhiali ecologici ingrosso, occhiali riciclati, occhiali bambu, occhiali bio-acetato`,
  openGraph: {
...
export default function EcoFriendlyPageIt() {
  return (
    <>
      ...
      <main className="py-12">
        ...
        {/* Hero Image */}
        <div className="mb-12">
          <img src="https://images.unsplash.com/photo-1625591348697-c75b4d7ea5f9?w=1200&h=500&fit=crop" alt="Wholesale Eco-Friendly Sunglasses" loading="lazy" className="w-full h-64 md:h-80 object-cover rounded-xl shadow-lg" />
        </div>
          ...
          <section className="mb-20">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <Link href="/it/prodotti/wayfarer" className="bg-white rounded-xl p-6 border border-gray-100 hover:shadow-lg transition-all group">

...
export const metadata: Metadata = {
  title: `Produttore Occhiali TR90 | Fabbrica Eyewear Ultraleggero TR90 - EyeView`,
  description: `Produttore di occhiali TR90. Montature ultraleggere Grilamid TR90 (15-20g), materiale flessibile a memoria, ipoallergenico. MOQ 100 pezzi.`,
  keywords: `produttore occhiali TR90, occhiali TR90 ingrosso, fabbrica occhiali ultraleggeri, Grilamid TR90`,
  openGraph: {
...
export default function TR90PageIt() {
  return (
    <>
          ...
          <div className="max-w-4xl mx-auto mb-16">
            <div className="prose prose-lg max-w-none text-gray-600 leading-relaxed">
              ...
              <p className="text-lg leading-relaxed mb-4">
                Here are the numbers that matter: a finished TR90 frame weighs 15-20 grams. For comparison, acetate frames weigh 25-35 grams and metal frames weigh 28-35 grams. That 10-15 gram difference might not sound like much on paper, but put a TR90 frame on your face after wearing acetate all day and you will immediately understand why athletes, outdoor professionals, and increasingly everyday consumers are switching. You forget they are there. No pressure on the nose, no sliding, no red marks behind the ears. For <Link href="/it/prodotti/sportivo" className="text-primary-600 hover:underline">sports brands</Link> and <Link href="/it/prodotti/bambini" className="text-primary-600 hover:underline">kids eyewear</Link>, TR90 is not just a good option — it is the obvious choice.
              </p>
              <p className="text-lg leading-relaxed mb-4">
        ...
        <div className="mb-12">
          ...
          <section className="mb-20">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              ...
              <Link href="/it/prodotti/bambini" className="bg-white rounded-xl p-6 border border-gray-100 hover:shadow-lg transition-all group">
                <div className="text-4xl mb-3">👶</div>

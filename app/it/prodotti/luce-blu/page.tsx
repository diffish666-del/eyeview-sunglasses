...
export const metadata: Metadata = {
  title: `Occhiali Luce Blu all'Ingrosso | Produttore Occhiali Computer - EyeView`,
...
export default function BlueLightPageIt() {
  return (
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <section className="text-center bg-primary-50 rounded-2xl p-8 md:p-12">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/it/contatti" className="btn-primary">Get Blue Light Catalog</Link>

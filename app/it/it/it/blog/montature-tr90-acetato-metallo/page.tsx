...
export const metadata: Metadata = {
  ...
  alternates: {
    ...
    languages: {
      ...
      'it': '/it/blog/montature-tr90-acetato-metallo',
    },
  },
}
    ...
    <article className="py-12">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          "@type": "Article",
          "headline": "Montature TR90 vs Acetato vs Metallo: La Guida Completa dell'Acquirente 2026",
        ...
        <header className="mb-12">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
            Montature TR90 vs Acetato vs Metallo: La Guida Completa dell'Acquirente 2026
          </h1>
          <p className="text-xl text-gray-600">
            Fabbrico montature per occhiali da oltre 10 anni. E la domanda #1 che i proprietari di marchi mi fanno: 
            Quale materiale devo usare? La risposta dipende dal tuo punto di prezzo, il tuo cliente e ciò che stai cercando di raggiungere. Lasciami dettagliare.
          </p>
        ...
        <nav className="bg-gray-100 rounded-xl p-6 mb-12">
          ...
          <ul className="space-y-2">
            <li><a href="#i-tre-materiali" className="text-primary-600 hover:underline">I Tre Materiali Principali</a></li>
            <li><a href="#tr90" className="text-primary-600 hover:underline">TR90: La Meraviglia Flessibile</a></li>
            <li><a href="#acetato" className="text-primary-600 hover:underline">Acetato: Lo Standard di Moda</a></li>
            <li><a href="#metallo" className="text-primary-600 hover:underline">Metallo: La Scelta Classica</a></li>
            <li><a href="#confronto" className="text-primary-600 hover:underline">Confronto Lato a Lato</a></li>
            <li><a href="#costo" className="text-primary-600 hover:underline">Dettaglio dei Costi per il Tuo Marchio</a></li>
            <li><a href="#scegliere" className="text-primary-600 hover:underline">Come Scegliere il Materiale Giusto</a></li>
            <li><a href="#tendenze" className="text-primary-600 hover:underline">Tendenze Materiali 2026</a></li>
            <li><a href="#faq" className="text-primary-600 hover:underline">Domande che Mi Fanno Ogni Settimana</a></li>
          </ul>
        </nav>

        <section id="i-tre-materiali" className="mb-12">
          <h2 className="text-3xl font-bold text-gray-900 mb-6">I Tre Materiali Principali</h2>
        ...
        <section id="tr90" className="mb-12">
          <h2 className="text-3xl font-bold text-gray-900 mb-6">TR90: La Meraviglia Flessibile</h2>
          
          <h3 className="text-2xl font-bold text-gray-900 mb-4">Cos'è TR90?</h3>
          <p className="text-gray-700 mb-4">
            TR90 è un materiale termoplastico sviluppato dall'azienda svizzera EMS-Chimie. Tecnicamente chiamato &quot;Gril TR90&quot; (questo è il nome del marchio), ma tutti nell'industria lo chiamano semplicemente TR90. È noto per essere incredibilmente leggero e flessibile.
          </p>
          ...
          <ul className="list-disc pl-6 space-y-2 text-gray-700 mb-6">
            <li>Occhiali da sole sportivi e stile di vita attivo</li>
            <li>Occhiali da sole per bambini (flessibili, leggeri, infrangibili)</li>
            <li>Linee di moda economiche</li>
            <li>Design avvolgenti e di performance</li>
            <li>Clienti che vogliono comfort tutto il giorno</li>
          </ul>
        ...
        <section id="acetato" className="mb-12">
          <h2 className="text-3xl font-bold text-gray-900 mb-6">Acetato: Lo Standard di Moda</h2>
          
          <h3 className="text-2xl font-bold text-gray-900 mb-4">Cos'è l'Acetato?</h3>
          <p className="text-gray-700 mb-4">
            L'acetato (acetato di cellulosa) è una plastica di origine vegetale fatta da fibre di cotone o polpa di legno. È il materiale premium di scelta per occhiali di moda. Marchi di lusso come Tom Ford, Gucci, Prada e Ray-Ban usano quasi esclusivamente acetato per le loro montature di moda.
          </p>
          ...
          <h3 className="text-2xl font-bold text-gray-900 mb-4">Ideale Per</h3>
          <ul className="list-disc pl-6 space-y-2 text-gray-700 mb-6">
            <li>Marchi di moda e lusso</li>
            <li>Pezzi di dichiarazione e design audaci</li>
            <li>Prezzi premium al dettaglio ($80-$300+)</li>
            <li>Marchi che vogliono combinazioni uniche di colore/motivo</li>
            <li>Clienti che valorizzano l'artigianato e la sensazione premium</li>
          </ul>
        ...
        <section id="metallo" className="mb-12">
          <h2 className="text-3xl font-bold text-gray-900 mb-6">Metallo: La Scelta Classica</h2>
          
          <h3 className="text-2xl font-bold text-gray-900 mb-4">Di Cosa Sono Fatte le Montature in Metallo</h3>
          <p className="text-gray-700 mb-4">
            Le montature di occhiali da sole in metallo sono tipicamente fatte di:
          </p>
          <ul className="list-disc pl-6 space-y-2 text-gray-700 mb-6">
          ...
          <div className="bg-red-50 border-l-4 border-red-500 p-4 mb-6">
            <p className="text-red-800 font-medium">⚠️ Avviso di Fabbrica: Specifica sempre &quot;senza nichel&quot; quando cerchi montature in metallo. L'allergia al nichel è una delle allergie da contatto più comuni al mondo. Chiedi al tuo fornitore la certificazione SGS o RoHS per verificare la composizione della lega.</p>
          </div>
        </section>

        <section id="faq" className="mb-12">
          <h2 className="text-3xl font-bold text-gray-900 mb-6">Domande che Mi Fanno Ogni Settimana</h2>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-gray-50 rounded-lg p-6">
              <h3 className="text-xl font-bold text-gray-900 mb-3">Quale materiale di montatura è migliore per occhiali di moda?</h3>
              <p className="text-gray-700">
                L'acetato è lo standard d'oro per occhiali di moda. Può essere tagliato in forme audaci e spesse, lucidato ad alto brillo, e viene in centinaia di colori e motivi (tartarugato, marmo, sfumato, trasparente). Marchi di lusso come Tom Ford, Gucci e Prada usano quasi esclusivamente acetato. Se il tuo marchio si posiziona nel segmento premium o di moda, l'acetato è ciò che i tuoi clienti si aspettano.
              </p>
            </div>

            <div className="bg-gray-50 rounded-lg p-6">
              <h3 className="text-xl font-bold text-gray-900 mb-3">Quanto costano diversi materiali di montatura all'ingrosso?</h3>
              <p className="text-gray-700">
                All'ingrosso in fabbrica: montature TR90 costano $3-8/paio a seconda della complessità. Montature in acetato costano $5-15/paio (acetato premium lucidato a mano può raggiungere $20+). Montature in metallo costano $4-12/paio a seconda della lega e rivestimento. Quindi TR90 è il più economico, acetato ha la gamma più ampia, e metallo si trova nel mezzo.
              </p>
            </div>

            <div className="bg-gray-50 rounded-lg p-6">
              <h3 className="text-xl font-bold text-gray-900 mb-3">Le montature in metallo sono migliori per persone con allergie?</h3>
              <p className="text-gray-700">
                Dipende dal metallo. L'acciaio inossidabile e il titanio sono ipoallergenici e sicuri per pelle sensibile. Tuttavia, alcune leghe metalliche più economiche contengono nichel, che può causare reazioni allergiche. Se stai cercando montature in metallo per un marchio, specifica sempre leghe senza nichel e chiedi la certificazione SGS o RoHS. TR90 e acetato sono naturalmente ipoallergenici.
              </p>
            </div>
          </div>
        </section>
        ...
        <div className="mt-12 pt-8 border-t border-gray-200">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Link href="/it/prodotti/tr90" className="block group">
              <div className="bg-gray-100 rounded-lg p-6 text-center group-hover:bg-gray-200 transition-colors">
                <h3 className="font-bold text-gray-900 mb-2">Occhiali TR90</h3>
                <p className="text-sm text-gray-600">Leggeri e flessibili</p>
              </div>
            </Link>
            <Link href="/it/prodotti/acetato" className="block group">
              <div className="bg-gray-100 rounded-lg p-6 text-center group-hover:bg-gray-200 transition-colors">
                <h3 className="font-bold text-gray-900 mb-2">Occhiali in Acetato</h3>
                <p className="text-sm text-gray-600">Montature di moda premium</p>
              </div>
            </Link>
            <Link href="/it/prodotti/metallo" className="block group">
              <div className="bg-gray-100 rounded-lg p-6 text-center group-hover:bg-gray-200 transition-colors">
                <h3 className="font-bold text-gray-900 mb-2">Occhiali in Metallo</h3>
                <p className="text-sm text-gray-600">Classici ed eleganti</p>
              </div>
            </Link>
          </div>
        </div>

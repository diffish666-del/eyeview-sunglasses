      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <section className="mb-20">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <CertificationCard
              ...
              description={<>
                Our{' '}
                <Link href="/it/prodotti/bambini" className="text-primary-600 hover:underline">kids&apos; sunglasses</Link> meet 
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <InspectionCard
              ...
              description={<>
                ...
                <Link href="/it/prodotti" className="text-primary-600 hover:underline">lens technology guide</Link> for 
        ...
        <section className="bg-gray-900 text-white rounded-2xl p-8 md:p-12 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/it/contatti" className="btn-primary">
              Request Documentation
            </Link>
            <Link href="/it/prodotti" className="border-2 border-white text-white font-semibold px-6 py-3 rounded-lg hover:bg-white hover:text-gray-900 transition-colors">
              Browse Products
            </Link>
          </div>
        </section>

  ...
  return (
    <section className="bg-primary-600 text-white rounded-2xl p-8 md:p-12 text-center">
      ...
      <div class="flex flex-col sm:flex-row gap-4 justify-center">
        ...
        <a href="/whatsapp/?src=geo" target="_blank" rel="noopener noreferrer" className="bg-green-500 text-white px-8 py-3 rounded-lg font-bold hover:bg-green-600 transition-colors inline-flex items-center gap-2">
